  ...
  <div class="container">
    <div class="row p-5">
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 vcard">
        ...
        <p class="mt-3"><i class="fal fa-copyright"></i> Copyright <a class="url fn" target="_blank" href="https://tungpham42.info/">Tung Pham</a></p>
      </div>
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3">
        <ul class="list-unstyled">
          ...
          <li>
            <a class="lang" href="{{ $langUrl }}"><i class="fal fa-language"></i> Tiếng Việt</a>
          </li>
        </ul>
      </div>
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3">
