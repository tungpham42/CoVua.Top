...
<p class="w-100 text-center mt-2">
  <span class="alert alert-success d-inline-block" role="alert">Bạn được mời</span>
</p>
@endsection
@section('belowContent')
<p class="w-100 text-center mt-4">
  <a id="white-link" class="w-25 btn btn-light btn-lg" href="{{ URL::to('/') }}/phong/{{ $roomCode }}/trang"><i class="fad fa-chess-clock-alt"></i> Bên TRẮNG</a>
  <a id="black-link" class="w-25 btn btn-dark btn-lg" href="{{ URL::to('/') }}/phong/{{ $roomCode }}/den"><i class="fad fa-chess-clock"></i> Bên ĐEN</a>
</p>
<script>
...
window.onload = function(){
  if (board.orientation() == 'black' && game.turn() === 'w') {
    location.href = $('#white-link').attr('href');
  }
};
